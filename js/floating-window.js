...
************************************************************************************************************/
	...
	*/	
	...
	function hideWindow()
	{
		delete openWindow[idWindowMap[this.id.replace(/[^\d]/g,'')]];
		delete idWindowMap[this.id.replace(/[^\d]/g,'')];
		switchElement(false,document.getElementById('dhtml_goodies_id' + this.id.replace(/[^\d]/g,'')));	
		document.getElementById('dhtml_goodies_id' + this.id.replace(/[^\d]/g,'')).parentNode.removeChild(document.getElementById('dhtml_goodies_id' + this.id.replace(/[^\d]/g,'')));
	}
