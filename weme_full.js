...
function updateParentCheckboxStatus() {
  ...
  /*
  if (!((document.getElementById('filterpeopletypedivChBox').style.opacity == 1) && (document.getElementById('filterpeoplelistdivChBox').style.opacity == 1)) || 
  ...
  if (!((document.getElementById('filterpreternaturaltypedivChBox').style.opacity == 1) && (document.getElementById('filterpreternaturalnamedivChBox').style.opacity == 1)) || 
  ...
  if (!((document.getElementById('filtertextfirstauthordivChBox').style.opacity == 1) && (document.getElementById('filtertextfirstlistdivChBox').style.opacity == 1) &&
...
var img_prefix = ''  // 'http://weme-dev.uszkalo.com/throwing-bones/'
  ...
  ajaxRequest.onreadystatechange = function() {
    if(ajaxRequest.readyState == 4) {
      document.getElementById("frontCardPage").innerHTML = "<div style='position: absolute; top: 30px; left: 20px; width: 1000px; height: 680px; margin: 10px; background: white; border-radius: 20px; -moz-border-radius: 20px;'> \
        ...
        <A HREF='javascript:closeOpenedCard()'><img width=60 heigth=60 src='" + img_prefix + "images/close.png' border='none' /></A> \
        </div>";
    }
  }
...
function loadContent(category, assertionid, picturefile) {
  ...
  if (picturefile != "-1")
      document.getElementById('myWaterMarkDiv').innerHTML = "<img border=\"none\" src=\"" + img_prefix + "newcards/" + picturefile +".png\" />";
}
...
function getNodeAt(x, y) {
  ...
  return shadowToCardMap[ UniqueColor.formatColor(data[0], data[1], data[2]) ];
	...
	function drawAnchor(thisx, thisy, thisfilename, shadowcolor){
		var img = new Image();
		if (thisfilename.charAt(0) == 'd' || thisfilename.charAt(0) == 'p')	img.src = 'http://witching.org/throwing-bones/thumbsroot/level' + zoomlevel + "/" + thisfilename;
		else									img.src = 'http://witching.org/throwing-bones/thumbsroot/level' + Math.max(zoomlevel-1,zoomUpperLimit) + "/" + thisfilename;
	...
	function drawAnchorMini(thisx, thisy, thisfilename, shadowcolor){
		var img = new Image();
		if (thisfilename.charAt(0) == 'd' || thisfilename.charAt(0) == 'p')	img.src = 'http://witching.org/throwing-bones/thumbsroot/level' + zoomlevelMini + "/" + thisfilename;
		else									img.src = 'http://witching.org/throwing-bones/thumbsroot/level' + Math.max(zoomlevelMini-1,zoomUpperLimit) + "/" + thisfilename;
...
var idWindowMap = new Array();
	...
	var icon1 = new GIcon(); 
	icon1.image = 'newicon/map_magics_4361ac.png';
	...
	var icon2 = new GIcon(); 
	icon2.image = 'newicon/supernatual_map.png';
	...
	var icon3 = new GIcon(); 
	icon3.image = 'newicon/map_damage_5959a7.png';
	...
	var icon4 = new GIcon(); 
	icon4.image = 'newicon/map_maleficium_3a5b6a.png';
	...
	var icon5 = new GIcon(); 
	icon5.image = 'newicon/map_law_dbab29.png';
	...
	var icon6 = new GIcon(); 
	icon6.image = 'newicon/map_testing_c76528.png';
	...
	var icon7 = new GIcon(); 
	icon7.image = 'newicon/death_solid.png';
	...
	var icon8 = new GIcon(); 
	icon8.image = 'newicon/healing_solid.png';
...
function createMarker(point, name, address, type, eventtype, eventdate, eventtypeorig, sourcetitle) {
	...
	var lineSize = 30;
	var picturesHTML = "<td><center><img src='" + img_prefix + "thumbsroot/level9/" + typenamearray[0] + ".png'></center></td>";
	var eventHTML = "<td><center><B>Event Type 1<BR>" + eventtypearray[0] + "</B></center></td>";

	if (typeof typenamearray[1] != 'undefined') {
		picturesHTML += "<td><center><img src='" + img_prefix + "thumbsroot/level9/" + typenamearray[1] + ".png'></center></td>";
		eventHTML += "<td><center><B>Event Type 2<BR>" + eventtypearray[1] + "</B></center></td>";
		lineSize = 50;
	}
	if (typeof typenamearray[2] != 'undefined') {
		picturesHTML += "<td><center><img src='" + img_prefix + "thumbsroot/level9/" + typenamearray[2] + ".png'></center></td>";
		eventHTML += "<td><center><B>Event Type 3<BR>" + eventtypearray[2] + "</B></center></td>";
		lineSize = 60;
	}
	if (typeof typenamearray[3] != 'undefined') {
		picturesHTML += "<td><center><img src='" + img_prefix + "thumbsroot/level9/" + typenamearray[3] + ".png'></center></td>";
		eventHTML += "<td><center><B>Event Type 4<BR>" + eventtypearray[3] + "</B></center></td>";
		lineSize = 70;
	}
	if (typeof typenamearray[4] != 'undefined') {
		picturesHTML += "<td><center><img src='" + img_prefix + "thumbsroot/level9/" + typenamearray[4] + ".png'></center></td>";
		eventHTML += "<td><center><B>Event Type 5<BR>" + eventtypearray[4] + "</B></center></td>";
		lineSize = 80;
	}
	if (typeof typenamearray[5] != 'undefined') {
		picturesHTML += "<td><center><img src='" + img_prefix + "thumbsroot/level9/" + typenamearray[5] + ".png'></center></td>";
